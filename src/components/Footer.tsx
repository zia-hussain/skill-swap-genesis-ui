...
export default function Footer() {
  return (
    <footer className="relative bg-brand-gradient text-brand-blue pt-12 overflow-hidden">
      <div className="container relative z-10 pb-6">
        {/* Main Footer Content */}
        <div className="grid lg:grid-cols-5 gap-12 mb-10">
          {/* Brand Section */}
          <div className="lg:col-span-2">
            <div className="mb-7">
              <div className="flex items-center gap-3 mb-8">
                <div className="w-12 h-12 bg-gradient-brand rounded-2xl flex items-center justify-center shadow">
              ...
              <div className="flex items-center gap-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className={`w-11 h-11 bg-gradient-to-r ${social.gradient} rounded-full flex items-center justify-center text-white hover:shadow-xl transition`}
                  >
          ...
          {/* Links Sections (Product, Legal, Community) */}
          <div>
        ...
        <div className="bg-soft-card rounded-section px-5 md:px-10 py-8 my-10 shadow-neumorph border border-white/11">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <Link
              ...
              className="px-7 py-2.5 btn-glass-yellow font-bold rounded-3xl shadow btn-shadow"
            >
              Join Early Access
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 pt-7 border-t border-brand-blue/10">
